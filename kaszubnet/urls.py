...
urlpatterns = [
    ...
    path('user_menu/new_character/', NewCharacterView.as_view(), name="new-character"),
    path('main_menu/<str:name>/', MainMenuView.as_view(), name="main-menu"),
    path('character_editor/<pk>', CharacterEditorView.as_view(), name="character-editor"),
    path('character_avatar_editor/', CharacterAvatarEditorView.as_view(), name="character-avatar-editor"),
